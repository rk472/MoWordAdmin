...
import studio.smartters.mowordadmin.adapter.DocumentAdapter;
...
public class AddDocumentActivity extends AppCompatActivity {
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if(resultCode==RESULT_OK){
            ...
            assert selectedDocUri != null;

                selectedPath=getPath(getApplicationContext(),selectedDocUri);
//                Log.e("path",selectedPath);
    ...
    private class UploadDoc extends AsyncTask<Void, Void, String> {

        @Override
        protected void onPreExecute() {
            super.onPreExecute();
            uploading = ProgressDialog.show(AddDocumentActivity.this, "Uploading File", "Please wait...", false, false);
        }
        ...
        protected void onPostExecute(String s) {
            ...
            try {
                ...
                if (s.split(":")[0].equals("success")) {
                    ...
                    dt.execute(Constants.URL + "addDocDB?name=" + s.split(":")[0]);
                } else {

                    Toast.makeText(AddDocumentActivity.this, s, Toast.LENGTH_SHORT).show();
                }
                Toast.makeText(AddDocumentActivity.this, selectedPath, Toast.LENGTH_SHORT).show();
                Log.e("err", selectedPath);
                //Toast.makeText(AddDocumentActivity.this, s, Toast.LENGTH_SHORT).show();
        ...
        protected String doInBackground(Void... params) {
            studio.smartters.mowordadmin.others.UploadDoc u = new studio.smartters.mowordadmin.others.UploadDoc();
